...
class SsoController extends Controller
{
    ...
    public function exchange(Request $request, IdentitySsoClient $client): JsonResponse
    {
        ...
        $request->session()->put('repo_watch_identity', $identity);
        $request->session()->put('repo_watch_identity_refreshed_at', now()->timestamp);
    ...
    public function logout(Request $request): JsonResponse
    {
        ...
        return $this->success(null, '已退出 Repo Watch');
    }
}
